...
CorMNIST_path = '../data/mnist_c'
CorCIFAR10_train = '../data/CorCIFAR10'
CorCIFAR10_test = '../data/CorCIFAR10'
...
def make_datasets(in_dset, aux_out_dset, test_out_dset, state, alpha, pi_1, pi_2, cortype):
    ...
    # train_in_data, aux_in_data, aux_in_data_cor, test_in_data, test_in_data_cor = load_in_mixMNIST_data(in_dset, rng, alpha)
